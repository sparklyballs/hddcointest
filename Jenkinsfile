...
environment {
	...
	CONTAINER_NAME = 'hddcointest'
	CONTAINER_REPOSITORY = 'sparklyballs/hddcointest'
	GITHUB_RELEASE_URL_SUFFIX = 'HDDcoin-Network/hddcoin-blockchain/releases/latest'
	GITHUB_REPOSITORY = 'sparklyballs/hddcointest'
